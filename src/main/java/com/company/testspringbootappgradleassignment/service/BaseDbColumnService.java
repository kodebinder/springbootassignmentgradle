package com.company.testspringbootappgradleassignment.service;

import com.company.testspringbootappgradleassignment.configuration.MappingConfiguration;
import com.company.testspringbootappgradleassignment.constant.Constants;
import com.company.testspringbootappgradleassignment.dto.*;
import com.company.testspringbootappgradleassignment.entity.*;
import com.company.testspringbootappgradleassignment.repository.BaseDbColumnRepository;
import com.company.testspringbootappgradleassignment.utility.*;
...
public class BaseDbColumnService {
    ...
    public void createBaseDbColumnsFromDto() throws ParseException, IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        for (int i = 0; i < cacheValues.size(); i++) {
            ...
            for (Object obj : objects) {
                if (obj.toString().contains(Constants.ADDRESSDTO_WITH_BRACKET) || obj.toString().contains(Constants.ADDRESSDTO_WITH_CURLY_BRACKET)) {
                    ...
                    parseFields(clazz);
                } else if (obj.toString().contains(Constants.BANKACCOUNTDTO_WITH_BRACKET) || obj.toString().contains(Constants.BANKACCOUNTDTO_WITH_CURLY_BRACKET)) {
                    ...
                    parseFields(clazz);
                } else if (obj.toString().contains(Constants.BANKOPERATIONDTO_WITH_BRACKET) || obj.toString().contains(Constants.BANKOPERATIONDTO_WITH_CURLY_BRACKET)) {
                    ...
                    parseFields(clazz);
                } else if (obj.toString().contains(Constants.COMPANYDTO_WITH_BRACKET) || obj.toString().contains(Constants.COMPANYDTO_WITH_CURLY_BRACKET)) {
                    ...
                    parseFields(clazz);
                } else if (obj.toString().contains(Constants.PORTFOLIODTO_WITH_BRACKET) || obj.toString().contains(Constants.PORTFOLIODTO_WITH_CURLY_BRACKET)) {
                    ...
                    parseFields(clazz);
                } else if (obj.toString().contains(Constants.POSITIONDTO_WITH_BRACKET) || obj.toString().contains(Constants.POSITIONDTO_WITH_CURLY_BRACKET)) {
                    ...
                    parseFields(clazz);
                } else if (obj.toString().contains(Constants.USERDTO_WITH_BRACKET) || obj.toString().contains(Constants.USERDTO_WITH_CURLY_BRACKET)) {
    ...
    public List<Object> getAllExistingDtoInsidePackage() throws IOException, ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, ParseException {
        Class[] classes = getClasses("com.company.testspringbootappgradleassignment.dto");
    ...
    private void parseFields(Class<?> clazz) {
        ...
        for (Field field : fields) {
            ...
            baseDbColumn.setName(field.getName());
            baseDbColumn.setLabel(field.getName());
            baseDbColumn.setType(String.valueOf(field.getAnnotatedType()));
            baseDbColumn.setGroupedValues(getGroupedValues());
